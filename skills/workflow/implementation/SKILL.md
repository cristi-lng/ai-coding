...
- 3.1. **Implementation** — announce **[Task X/N — Implementation: Task name]** (X = task's position in the full list, N = total tasks)
...
- 3.2. **Review** — announce **[Task X/N — Review: Task name]**
...
- 3.3. **Complete** — announce **[Task X/N — Complete: Task name]**
